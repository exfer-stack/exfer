...
// B-OPERATIONAL OVERRIDE (ops/b-assume-valid-668000): checkpoint raised
// from 500_000 to 668_000 so the exfer-rpc fly node boots in minutes off a
// pre-#9/#16 volume clone instead of re-verifying ~168k Argon2id PoWs (~12h).
// Regenerated 2026-05-30 via tools/regen_assume_valid.py 668000 (S2+S3
// byte-exact agreement) and cross-checked: block_id@668000 ==
// 20510931db013528e7402151d55079cd82e3ec63aec616540b3d427ec886bbd4 on a third
// node. DO NOT MERGE TO MAIN — this trusts the chain below 668_000.
pub const ASSUME_VALID_HEIGHT: u64 = 668_000;
/// Block hash at ASSUME_VALID_HEIGHT. Verified exactly once during sync.
pub const ASSUME_VALID_HASH: [u8; 32] = [
    0x20, 0x51, 0x09, 0x31, 0xdb, 0x01, 0x35, 0x28,
    0xe7, 0x40, 0x21, 0x51, 0xd5, 0x50, 0x79, 0xcd,
    0x82, 0xe3, 0xec, 0x63, 0xae, 0xc6, 0x16, 0x54,
    0x0b, 0x3d, 0x42, 0x7e, 0xc8, 0x86, 0xbb, 0xd4,
];
...
pub const ASSUME_VALID_CUMULATIVE_WORK: [u8; 32] = [
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x06, 0x4a, 0x8d, 0x19, 0x64, 0x8f,
];
